...
$string['url_details'] = 'The site URL';
$string['sif_width'] = 'Display Width';
$string['sif_width_details'] = 'Enter the desired width of the display';
$string['sif_height'] = 'Display Height';
$string['sif_height_details'] = 'Enter the desired height of the display';
$string['sif_display'] = 'Page Type';
$string['sif_display_details'] = 'Choose the desired type of display';
